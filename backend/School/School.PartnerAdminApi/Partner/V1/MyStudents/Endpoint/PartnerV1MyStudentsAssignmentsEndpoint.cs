...
public sealed class PartnerV1MyStudentsAssignmentsEndpoint : IEndpointMarker
{
    public IEndpointRouteBuilder Map(IEndpointRouteBuilder app)
    {
        ...
        // Teachers stay read-only for uploads: the upload POST is not on the
        // teacher whitelist in RolePathGuardMiddleware, so only regular
        // partner staff can use it. Comments remain open to teachers.
