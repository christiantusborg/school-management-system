...
public sealed class AdminV1StudentsExportEndpoint : IEndpointMarker
{
    ...
    private sealed record ExportEnrolment(
        ...
        int? DurationMonths,
        int? ProgrammeMinDurationMonths,
        int? ProgrammeMaxDurationMonths,
        int? ApprovedDurationValue,
        string? ApprovedDurationUnit,
    ...
    private static readonly Column[] Columns = new Column[]
    {
        ...
        new("pathwayName",         "Entry Requirement",          true,  (_, e) => e?.PathwayName),
        new("pathwayMinYearsExp",  "Entry Requirement min yrs exp", true, (_, e) => e?.PathwayMinYearsExperience),
        ...
        new("durationMonths",      "Duration (months, default)", true, (_, e) => e?.DurationMonths),
        new("programmeMinDurationMonths", "Programme min duration (months)", true, (_, e) => e?.ProgrammeMinDurationMonths),
        new("programmeMaxDurationMonths", "Programme max duration (months)", true, (_, e) => e?.ProgrammeMaxDurationMonths),
        new("approvedDuration", "Approved duration", true, (_, e) => e?.ApprovedDurationValue is null ? null : SharedLibrary.Basics.Opaque.Domains.DurationDays.Display(e.ApprovedDurationValue, e.ApprovedDurationUnit)),
