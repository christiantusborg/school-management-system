...
public class SchoolMailSettingsConfiguration : IEntityTypeConfiguration<SchoolMailSettings>
{
    public void Configure(EntityTypeBuilder<SchoolMailSettings> builder)
    {
        builder.HasKey(e => e.SchoolMailSettingsId);
        builder.HasIndex(e => e.SchoolId).IsUnique();
        ...
        // Secrets: AES-256-GCM at rest, same scheme as the global MailSettings.
