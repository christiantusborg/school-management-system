          ...
          <div v-for="maj in specializationsFor(prog.programmeId)" :key="maj.specializationId" class="maj-card">
            ...
            <div v-if="xMaj === maj.specializationId" class="subj-table">
              ...
              <div v-for="s in subjectsFor(maj.specializationId)" :key="s.subjectId" class="subj-row">
                ...
                <span @click.stop style="margin-right:.5rem"><SubjectRubricButton :subject="s" /></span>
...
.ms-def { display: inline-flex; align-items: center; gap: 2px; font-size: .72rem; color: #6b7888; white-space: nowrap; }
.inp-msdef { width: 54px; padding: .15rem .3rem; border: 1px solid #cfd7e3; border-radius: 4px; font-size: .78rem; }
</style>
